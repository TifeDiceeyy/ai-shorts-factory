    ...
    def design_mascot(self, topic: str, brief: dict[str, Any] | None, cost_tracker: CostTracker) -> dict[str, Any]:
        ...
        design = {
            ...
            "hero_prompt": (
                ...
                "centered vertically in frame, occupying no more than 40% of vertical height, with generous "
...
def _mascot_design_prompt(topic: str, brief: dict[str, Any] | None) -> str:
    ...
    return (
        ...
        "and centered vertically in frame occupying no more than 40% of vertical height, with generous empty "
